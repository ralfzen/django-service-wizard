"""
Django settings for sayhello_service project.
...
ROOT_URLCONF = 'sayhello_service.urls'
...
WSGI_APPLICATION = 'sayhello_service.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        'sayhello_service.permissions.AllowOptionsAuthentication',
    )
}
